    ...
    */
    ...
    if (in_array ($mode, array (FRAME, TREE, EDITOR, DOWNLOAD_HERE, LOGIN))) {
        $css_files = array (
            ...
            FILE_ROOT . 'scripts/codemirror/lib/codemirror.css',
            FILE_ROOT . 'scripts/codemirror/theme/monokai.css',
            FILE_ROOT . 'css/custom.css'
        );
?>
        <html><head>
